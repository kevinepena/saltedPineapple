...
describe('<CreateItem />', () => {
    ...
    it('uploads a file when changed', async () => {
        ...
        input.simulate('change', { target: { files: ['fakedog.png'] } });
        await wait();
    ...
    it('handles state upoading', async () => {
        const wrapper = mount(
            <MockedProvider>
                <CreateItem />
            </MockedProvider>
        ...
        wrapper.find('#description').simulate('change', { target: { value: 'This is an item', name: 'description' } });
